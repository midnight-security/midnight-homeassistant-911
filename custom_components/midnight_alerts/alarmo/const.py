...
VERSION = "1.10.18"
NAME = "Midnight 911 – Alarm Panel"
MANUFACTURER = "@nielsfaber"

# Internal-only namespace key for hass.data / storage - not a registered HA
# integration domain anymore (Alarmo is merged into midnight_alerts). Kept as
# "alarmo" so existing .storage/alarmo.storage data keeps loading unchanged.
DOMAIN = "alarmo"
...
# This is the only sidebar panel now that midnight_alerts's own standalone
# panel was removed, so it's titled for the whole product, not just "Alarm
# Panel" (NAME, used for the device name/model, stays more specific).
